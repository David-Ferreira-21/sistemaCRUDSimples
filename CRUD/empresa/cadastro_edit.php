        ...
        <!--Depois de tudo, preciso de um formulário-->
            ...
            <form action="edit_script.php" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Digite seu número . . ." name="telefone" value=" <?php echo $linha['telefone']; ?>">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" placeholder="Digite seu E-mail . . ." name="email" value=" <?php echo $linha['email']; ?>">
