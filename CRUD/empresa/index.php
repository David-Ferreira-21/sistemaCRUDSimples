        ...
        <!--Dentro de linhas vem colunas-->    
            <div class="col">
              ...
              <div class="jumbotron">
                ...
                <p class="lead">Este é um sistema simplificado de cadastro. Base de estudos para criação de sistemas Web com PHP e MySQL. Sistema com CRUD (Adiciona / lê/ edita/ deleta)</p>
                <hr class="my-4">
